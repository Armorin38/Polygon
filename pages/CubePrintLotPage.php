            ...
            <div class="content-div" id="content-div">
                ...
                <script defer>
                    const geometry = new THREE.BoxGeometry( 30, 30, 30 );
                        ...
                        frontSpot.position.set(100, 100, 100);
                        scene.add(frontSpot);
                ...
                <div class='info-lotPrint'> <br><span class='lot-namePrint'>Название: Cube</span>
                <br><span class='autor-lotPrint'>Автор: Admin</span>   
                </div>
                <div class='sell-div'>
                    <form action='PrintOrder.php' method='post'>
                        <input type='hidden' name='lotName' value="Cube"></input>
                        <input type='hidden' name='username' value='<?echo $Username?>'></input>
                    <input class='download-link-2' type='submit' name='submit' value='Заказать печать'></input></form></div>
            </div>
